classdef test_integrate_points <  TestCaseWithSave
    % Test class to test point averaging algorithm
    
    methods
        function obj = test_integrate_points (name)
        ...
        function test_0(obj)
            ...
            % Integral using points as boundaries
            ...
            % Perform integration
            [sout, eout] = integrate_points (x, s, e, 1, xout);
        ...
        function test_1(obj)
            ...
            [sout1_ref, eout1_ref] = integrate_points (x, s, e, 1, x);
        ...
        function test_2(obj)
            ...
            [sfinal_ref, efinal_ref] = integrate_points (x, s, e, 1, xfinal);
            ...
            % Sum integrals in quadrature onto final bins
