classdef test_job_executor< MPI_Test_Common
    ...
    methods
        ...
        %
        function test_worker_fails(obj,varargin)
            if nargin>1
                obj.setUp();
        ...
        %
        function test_worker(obj,varargin)
            if nargin>1
                obj.setUp();
                clob0 = onCleanup(@()(tearDown(obj)));
            end
        ...
        %
        function test_log_progress_with_fail(obj,varargin)
            if nargin>1
                obj.setUp();
                clob0 = onCleanup(@()(tearDown(obj)));
            end
        ...
        %
        function test_unhandled_error_in_init(obj,varargin)
            if nargin>1
                obj.setUp();
                clob0 = onCleanup(@()(tearDown(obj)));
            end
