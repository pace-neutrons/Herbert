classdef test_binning_parse_description < TestCaseWithSave
    ...
    methods
        %--------------------------------------------------------------------------
        function self = test_binning_parse_description (name)
        ...
        %==========================================================================
        % Test rebin_binning_description_parse
        ...
        function test_1 (self)
            ...
            output = cell(1,4);
            [output{:}] = IX_dataset.test_gateway('rebin_binning_description_parse',...
                [-Inf,Inf], bin_opts);
        ...
        function test_5 (self)
            ...
            bin_opts = self.bin_opts_default;
            f = @()IX_dataset.test_gateway('rebin_binning_description_parse',...
                [-Inf,4,10,1,10,2,Inf], bin_opts); 
            assertExceptionThrown(f, 'HERBERT:rebin_binning_description_parse:invalid_argument');
        end
