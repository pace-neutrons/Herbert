classdef IX_dataset_4d < IX_data_4d
    % Class adds operations with graphics to main operations with 4-d data
    %
    % See IX_data_4d for main properties and constructors, used to operate
    % with 4d data
    %
    % Constructor creates IX_dataset_4d object
    %
    %   >> w = IX_dataset_4d (x,y,z)
    %   >> w = IX_dataset_4d (x,y,z,signal)
    %   >> w = IX_dataset_4d (x,y,z,signal,error)
    %   >> w = IX_dataset_4d (x,y,z,signal,error,title,x_axis,y_axis,z_axis,s_axis)
    %   >> w = IX_dataset_4d (x,y,z,signal,error,title,x_axis,y_axis,z_axis,s_axis,x_distribution,y_distribution,z_distribution)
    %   >> w = IX_dataset_4d (title, signal, error, s_axis, x, x_axis, x_distribution,...
