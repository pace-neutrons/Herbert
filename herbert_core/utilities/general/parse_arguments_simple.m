function [par, keyval, present] = parse_arguments_simple (keywords, flags,...
    defaults, args)
% Parse argument list with keyword-value and optional flag names
%
%   >> [par, val] = keyval = parse_arguments_simple (keywords, flags,...
%                                                       defaults, args)
%
...
%   >> [par, keyval, present] = parse_arguments_simple (keywords, flags,...
%                                                           defaults, args)
% Results in:
%   par = {'data.dat', [10 15 20 25 30]}
% 
%   keyval = {[15000 19000], true, true}
% 
