...
% Remove dimensions of length one dimensions in an IX_dataset_4d object
%
...
% Input:
% -------
%   obj     IX_dataset_4d object or array of objects to squeeze
...
%           removal. Values must be in the range 1 to 4
%           Default: 1:4  (i.e. check all axes)
%
% Output:
% -------
%   obj_out IX_dataset_4d object or array of objects with dimensions of
...
%             - if obj is a single IX_dataset_4d object, obj_out is a
%               structure
%                   obj_out.val     value
%                   obj_out.err     standard deviation
%
%             - if obj is an array of IX_dataset_4d objects, then obj_out
