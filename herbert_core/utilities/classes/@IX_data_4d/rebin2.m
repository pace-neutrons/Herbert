...
% EXAMPLES
%   >> obj_out = rebin2 (obj, [],...)
%   >> obj_out = rebin2 (obj, 10,...)
%   >> obj_out = rebin2 (obj, [2000,3000],...)
%   >> obj_out = rebin2 (obj, [2000,Inf],...)
%   >> obj_out = rebin2 (obj, [2000,3000,4000,5000,6000],...)
%
...
obj_out = rebin_ (obj, 1:4, array_is_descriptor, varargin{:});
