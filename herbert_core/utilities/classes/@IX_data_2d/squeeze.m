...
% Remove dimensions of length one dimensions in an IX_dataset_2d object
%
...
% Input:
% -------
%   obj     IX_dataset_2d object or array of objects to squeeze
...
%           removal. Values must be in the range 1 to 2
%           Default: 1:2  (i.e. check all axes)
%
% Output:
% -------
%   obj_out IX_dataset_2d object or array of objects with dimensions of
...
%             - if obj is a single IX_dataset_2d object, obj_out is a
%               structure
%                   obj_out.val     value
%                   obj_out.err     standard deviation
%
%             - if obj is an array of IX_dataset_2d objects, then obj_out
