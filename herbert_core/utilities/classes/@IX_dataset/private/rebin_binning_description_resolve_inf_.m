function xb=rebin_boundaries_description_resolve_inf_...
        ...
        if numel(xbounds)==3 && isinf(xbounds(1)) && isinf(xbounds(3))
            ...
            elseif xbounds>0
                ...
                if xlo>0
                    ...
                    error('If lower limit is less than or equal to zero, the rebin descriptor [-Inf,dx,Inf] with dx<0 is invalid');
