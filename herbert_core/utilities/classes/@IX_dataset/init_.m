function obj_out = init_ (obj, varargin)
% Create a new IX_dataset object by updating an existing object
%
%   >> obj_out = init_ (obj, arg1, arg2, ...)
%
...
%                   identical to the constructor for the IX_dataset class
%
% Output:
% -------
%   obj_out         IX_dataset object, updated according to the provided
%                   input arguments.
%
% See also IX_dataset
...
obj_out = obj;
obj_out = build_IX_dataset_(obj_out, varargin{:});
