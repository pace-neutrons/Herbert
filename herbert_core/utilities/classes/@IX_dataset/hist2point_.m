...
%
% Leaves point data axes unchanged.
%
% Input:
% -------
...
% Output:
% -------
%   obj_out IX_dataset object with histogram axes converted to point axes
%
%
% NOTES:
%
% Histogram data axes are converted to point data as follows:
%
