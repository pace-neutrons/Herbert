classdef iMessagesFramework < handle
    ...
    methods
        ...
        function cs = get_worker_init(obj,intercom_name,labID,numLabs,varargin)
            ...
            if is_def('labID') % Herbert MPI worker. numlabs and labNum are defined by configuration
                if nargin> 4
    ...
    methods(Access = protected)
        ...
        function [from_task_id,mess_name,is_blocking]=check_receive_inputs(obj,from_task_id,mess_name,varargin)
            ...
            %
            %
            if ~is_def('from_task_id') || isempty(from_task_id) ||...
            ...
            if ~is_def('mess_name') %receive any message for this task
                mess_name = 'any';
            end
