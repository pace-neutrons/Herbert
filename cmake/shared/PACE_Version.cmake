...
if(NOT "${_release_type}" STREQUAL "RELEASE")
  ...
  if ("${_release_type}" STREQUAL "NIGHTLY" OR "${_release_type}" STREQUAL "BRANCH")
    set(SKIP_MERGES "")
  else()
    set(SKIP_MERGES "--no-merges")
  endif()
  execute_process(
    COMMAND ${GIT_EXECUTABLE} rev-list --abbrev-commit ${SKIP_MERGES} -n 1 HEAD
