...
% -----------------------
% Original rebin_hist_ algorithm from Horace for the past sveral years
% Note that the name of the file (rebin_hist_) does not match the function
% name: this is because of the reorganisation of IX_dataset_1d,2d etc that
% took place is c. 2017.
%
