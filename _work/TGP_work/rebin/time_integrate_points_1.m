function time_integrate_points_1 (nx0, nw)
% Tests of timing of trapezoidal integration in one dimension
%
%   >> time_integrate_points_1              % use default nx0 and nw
%   >> time_integrate_points_1 (nx0, nw)
%
...
% Integrate original (up to August 2021)
% --------------------------------------
tic
S = 0;
for i=1:numel(x)
...
disp([' Integrate original (up to August 2021): ',num2str(toc), ' seconds.'])


% Integrate vectorised version
% ----------------------------
tic
S = 0;
for i=1:numel(x)
...
disp(['                 Integrate loop version: ',num2str(toc), ' seconds.'])
