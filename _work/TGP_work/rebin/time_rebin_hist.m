...
disp('-----------------------------------------------------------------------------------')
disp('Rebin compare original and vectorised')
disp('-------------------------------------')
tic
S = 0;
...
disp('-----------------------------------------------------------------------------------')
disp('Rebin original (up to August 2021)')
disp('--------------')
tic
S = 0;
for i=1:numel(x)
...
%
%   >> hh_1d_gau=make_testdata_xye_hist (nx0, nw)
%
