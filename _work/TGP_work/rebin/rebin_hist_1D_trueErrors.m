function [sout, eout] = rebin_hist_1D_trueErrors(x, s, e, xout)
% Rebins histogram data along axis iax=1 of an IX_dataset_nd with dimensionality ndim=1.
%
%   >> [sout, eout] = rebin_hist_1D_trueErrors (x, s, e, xout)
%
% Input:
% ------
...
% -----------------------
% Refactored version of original rebin_hist_
% New algorithm for error bar calculation which consistently with split
% bins
%**************************************************************************
